...
**Old repository:** https://github.com/clouddrove/terraform-azure-flexible-postgresql

The module has been permanently migrated to the **terraform-az-modules** organization:

**➡️ New home:** https://github.com/terraform-az-modules/terraform-azurerm-flexible-postgresql
...
```hcl
module "example" {
   source      = "clouddrove/flexible-postgresql/azure"
}
```
...
```hcl
module "example" {
   source      = "terraform-az-modules/flexible-postgresql/azurerm"
}
```
